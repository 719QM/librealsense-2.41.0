...
int main(int argc, char * argv[]) try
{
    ...
    window app(1280, 720, "RealSense Record and Playback (RGB) Example");
    ...
    while(app) {
        ...
        rgb_image.render(rgb, { app.width() * 0.25f, app.height() * 0.25f, app.width() * 0.5f, app.height() * 0.75f }); // Render RGB image
    }
    return EXIT_SUCCESS;
}
